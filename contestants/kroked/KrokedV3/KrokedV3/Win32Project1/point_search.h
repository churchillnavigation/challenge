...
{
		std::vector<Foint> *foints;
		int64_t count;
		Moint *points;
		std::vector<Moint> *vpoints;
		std::vector<Moint> *vpoints2;
		...
		const std::vector<Foint> *fointsright;
		const std::vector<int32_t> *fointsrightrank;
		const std::vector<Foint> *fointsleft;
		const std::vector<int32_t> *fointsleftrank;
		float midx;
		//std::vector<Moint>::const_iterator low[CCHUNK+1];
		//std::vector<Moint>::const_iterator high[CCHUNK+1];
		//std::vector<Moint>::const_iterator low2[CCHUNK2+1];
		//std::vector<Moint>::const_iterator high2[CCHUNK2+1];
