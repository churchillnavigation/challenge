...
#define DLL_FUNCTION_POST //  __stdcall
...
//	LinearSearch *algorithm = new LinearSearch();
	HybridSearch *algorithm = new HybridSearch();
	algorithm->Create(points_begin, points_end);
	algorithm->PostCreate(points_begin, points_end);
