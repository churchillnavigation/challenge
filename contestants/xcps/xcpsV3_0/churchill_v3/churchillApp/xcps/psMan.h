...
struct SearchContext {
    ...
    cPointSearch_t<9, MAX_SEARCH_POINTS>* pPsL10;
    cPointSearch_t<8, MAX_SEARCH_POINTS>* pPsL9;
    cPointSearch_t<7, MAX_SEARCH_POINTS>* pPsL8;
    cPointSearch_t<6, MAX_SEARCH_POINTS>* pPsL7;
